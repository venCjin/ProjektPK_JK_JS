...
//		calendar.
		...
		calendar.getDayChooser().addPropertyChangeListener("day", new PropertyChangeListener() {
		    ...
		    public void propertyChange(PropertyChangeEvent evt) {
		        ...
		        System.out.println("Miesiac: " + calendar.getMonthChooser().getMonth()+1); //indexowanie od 0
		...
		mntmInfo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "ORGANIZER\nProgram stworzony na laboratoriach Programowania Komponentowego\nAutorzy: Jakub Klepacz, Jaros³aw Suchiñski", "Informacje o programie",1);
			}
		});
		mnInfo.add(mntmInfo);
