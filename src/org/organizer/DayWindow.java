...
/**
 * Okno dnia. Wyœwietla wszystkie wydarzenia trwaj¹ce w ci¹gu tego dnia. Pozwala
 * usuwaæ i edytowaæ wydarzenia.
 */
		...
		for (Event e : todayEvents) {
			...
			eventBtn.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent btn) {
					...
					int choice = JOptionPane.showOptionDialog(null, e.toString(), "Wydarzenie: " + e.getName(),
